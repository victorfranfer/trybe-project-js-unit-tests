...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    const getCharacterArya = getCharacter('Arya');
    expect(getCharacterArya).toEqual({name: 'Arya Stark', class: 'Rogue', phrases: ['Not today', 'A girl has no name.']});
    ...
    expect(getCharacter('Victor')).toBeUndefined();
  });
});
